...
function PlatformIcon({
  ...
  const d = platform === "claude_code" ? CLAUDE_PATH : OPENAI_PATH;
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      {open && (
        <div
          ...
          className="absolute left-1/2 -translate-x-1/2 top-[calc(100%+0.5rem)] z-50 whitespace-nowrap rounded-xl border border-border bg-card/95 p-1 shadow-lg backdrop-blur"
          aria-label={t("platform.switcherAria")}
        >
